  ...
  return (
    ...
    <div className='bg-amber-300 w-full mt-3 flex justify-between px-10 h-13 align-center border-2 border-black rounded-2xl absolute'>
      ...
      <div className="search flex gap-5">
        ...
        <button className='w-9 h-9 rounded-3xl border-2 border-black flex justify-center self-center bg-[#db94d1]'><svg class="self-center w-6 h-6 text-gray-800 dark:text-white" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
